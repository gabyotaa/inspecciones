...
-->
<div class="modal fade" id="mdlRefaccion" data-backdrop="static">
  <div class="modal-dialog" style="width:90%!important;">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">TIRE RACK</h4>
      </div>
      <div class="modal-body">
        <div class="row" align="center">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div id="groupRdTipoRin" class=" row-centered">
              <label class="btn btn-primary col-centered llanta btn-xs col-md-3 selRin" style="width:30%!important">
                <input type="radio" name="radiosTipoRin" id="rdCargada" value="NO">&nbsp;&nbsp;NO&nbsp;&nbsp;
              </label>
              <label class="btn btn-primary col-centered llanta btn-xs col-md-3 selRin" style="width:30%!important">
        ...
        <div class="row" align="center" style="padding-top: 20px;">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <label for="" class="tamanioTitulosllantas">COMMENTS</label><br>
            <div id="" class="row-centered">
              <textarea class="form-control" id="txtComentarioRefaccion" rows="3" maxlength="255"></textarea>
            </div>
          </div>  
        </div>
      </div>
      <div class="modal-footer">
        <div class="row">
          ...
          <button type="button" class="btn btn-primary botonesFoterModal" id="btnRefaccionCont" ><i class="fa fa-floppy-o"></i> SAVE</button>
        </div>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
